...
public class ContainerSelectionTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = runTime ; i < repeat; ++i) {
            ...
            //String inputFolder = ContainerOverbooking.class.getClassLoader().getResource("/home/carlos/Documents/ECCI/repo/cloudsim/modules/cloudsim-examples/src/main/resources/workload/planetlab").getPath();
            /**
...
//          String containerAllocationPolicy= "MostFull";
            ...
            String containerAllocationPolicy= "FirstFit"; //FirstFit
            /**
