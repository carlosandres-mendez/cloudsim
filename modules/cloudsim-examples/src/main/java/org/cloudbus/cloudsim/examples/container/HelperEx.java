...
//            Log.printLine(String.format("Number of VM migrations: %d", numberOfMigrations));
   ...
   //Now we create the log we need
        ...
        data.append(experimentName + delimeter);
        data.append(parseExperimentName(experimentName));
        data.append(String.format("numberOfHosts:"+"%d", numberOfHosts) + delimeter);
        data.append(String.format("numberOfVms:"+"%d", numberOfVms) + delimeter);
        data.append(String.format("totalSimulationTime:"+"%.2f", totalSimulationTime) + delimeter);
        data.append(String.format("slaOverall:"+"%.10f", slaOverall) + delimeter);
        data.append(String.format("slaAverage:"+"%.10f", slaAverage) + delimeter);
        data.append(String.format("slaTimePerActiveHost:"+"%.10f", slaTimePerActiveHost) + delimeter);
        data.append(String.format("meanTimeBeforeHostShutdown:"+"%.10f", meanTimeBeforeHostShutdown) + delimeter);
        data.append(String.format("stDevTimeBeforeHostShutdown:"+"%.10f", stDevTimeBeforeHostShutdown) + delimeter);
        data.append(String.format("medTimeBeforeHostShutdown:"+"%.10f", medTimeBeforeHostShutdown) + delimeter);
        data.append(String.format("meanTimeBeforeContainerMigration:"+"%.10f", meanTimeBeforeContainerMigration) + delimeter);
        ...
        data.append(String.format("meanDatacenterEnergy:"+"%.10f", meanDatacenterEnergy) + delimeter);
        data.append(String.format("stDevDatacenterEnergy:"+"%.10f", stDevDatacenterEnergy) + delimeter);
        data.append(String.format("medDatacenterEnergy:"+"%.10f", medDatacenterEnergy) + delimeter);
        data.append(String.format("totalContainerMigration:"+"%d", totalContainerMigration) + delimeter);
        data.append(String.format("totalVmMigration:"+"%d", totalVmMigration) + delimeter);
        data.append(String.format("totalVmCreated:"+"%d", totalVmCreated) + delimeter);
        data.append(String.format("numberOfOverUtilization:"+"%d", numberOfOverUtilization) + delimeter);
        data.append(String.format("energy:"+"%.5f", energy) + delimeter);
